...
add_action( 'wp_ajax_calc', 'calculate_function' );
add_action( 'wp_ajax_nopriv_calc', 'calculate_function' );
...
$id = $_POST['id'];
$today = $_POST['today'];
$summa = $_POST['count'] - $_POST['srvice'];
echo $summa;
$wpdb->query( 
  "UPDATE `wp_giftvouchers_list` SET `remaining_amount` = $summa WHERE `wp_giftvouchers_list`.`id` = $id;"
);

$wpdb->query( 
  "UPDATE `wp_giftvouchers_list` SET `remaining_date` = '$today' WHERE `wp_giftvouchers_list`.`id` = $id;"
);
...
function wpgv_front_enqueue() {
  ...
  wp_register_script('wpgv-voucher-script', WPGIFT__PLUGIN_URL  . '/assets/js/voucher-script.js', array('jquery'), '3.3.6', true);
  wp_register_script('wpgv-item-script', WPGIFT__PLUGIN_URL  . '/assets/js/item-script.js', array('jquery'), '3.3.6', true);
  wp_register_script('wpgv-woocommerce-script', WPGIFT__PLUGIN_URL  . '/assets/js/woocommerce-script.js', array('jquery'), '3.3.6', true);
...
add_action( 'wp_ajax_redeem_voucher', 'wpgv_redeem_voucher' );
